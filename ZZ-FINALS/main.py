...
def main_menu():
    ...
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("R.png"), pos=(640, 250),
                             text_input="PLAY", font=get_font(75), base_color="Blue", hovering_color="White")
        OPTIONS_BUTTON = Button(image=pygame.image.load("R.png"), pos=(640, 400),
                                text_input="OPTIONS", font=get_font(75), base_color="Blue", hovering_color="White")
        QUIT_BUTTON = Button(image=pygame.image.load("R.png"), pos=(640, 550),
